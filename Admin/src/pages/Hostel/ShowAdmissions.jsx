...
const ShowAdmissions = ({
  ...
  paymentAmount,
  setPaymentAmount,
  hostelFee, // Receive hostelFee prop
}) => {
      ...
      <div className="card-body">
        <div className="actions-row">
          ...
          <button onClick={handleAddDue} disabled={loading} className="btn-warning">
            {loading ? "Processing..." : `Add Monthly Due (₹${hostelFee || 4000})`}
          </button>
        </div>
        ...
        {showCashPopupFor && (
          <div className="hostel-modal-overlay">
            <div className="hostel-modal-content">
              <h3>Record Cash Payment for {`${showCashPopupFor.firstName} ${showCashPopupFor.lastName}`}</h3>
