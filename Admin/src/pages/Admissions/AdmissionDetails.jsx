          ...
          <div className="lg:col-span-2 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-3xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-y-8">
              <div>
                ...
                <p className="text-md font-semibold mt-1">{admission.name}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Father's Name</p>
                <p className="text-md font-medium mt-1">{admission.fatherName || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Mother's Name</p>
                <p className="text-md font-medium mt-1">{admission.motherName || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Date of Birth</p>
                <p className="text-md font-medium mt-1">{admission.dob || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Gender</p>
                <p className="text-md font-medium mt-1 capitalize">{admission.gender || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Phone Number</p>
                <p className="text-md font-medium mt-1">{admission.phone || "—"}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-3xl p-8">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-md font-bold mt-1">{admission.class}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Medium</p>
                <p className="text-md font-medium mt-1 capitalize">{admission.medium}</p>
              </div>
              {admission.stream && (
                <div>
                  <p className="text-sm text-[var(--text-muted)]">Stream</p>
                  <p className="text-md font-medium mt-1 capitalize">{admission.stream}</p>
                </div>
              )}
            </div>
          </div>
          ...
          <div className="lg:col-span-3 bg-[var(--bg-surface)] border border-[var(--border-default)] rounded-3xl p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div>
                ...
                <p className="text-md mt-1">{admission.address?.village || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Post Office</p>
                <p className="text-md mt-1">{admission.address?.postOffice || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Police Station</p>
                <p className="text-md mt-1">{admission.address?.policeStation || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">District</p>
                <p className="text-md mt-1">{admission.address?.district || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">State</p>
                <p className="text-md mt-1">{admission.address?.state || "—"}</p>
              </div>
              <div>
                <p className="text-sm text-[var(--text-muted)]">Pincode</p>
                <p className="text-md mt-1">{admission.address?.pincode || "—"}</p>
              </div>
            </div>
          </div>
        </div>
