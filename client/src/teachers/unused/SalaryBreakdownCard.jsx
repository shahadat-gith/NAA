  ...
  return (
    <div className="sbc-wrapper">
      <div className="sbc-header">
        <h2 className="sbc-title">Pending Salary Breakdown</h2>

        <div className="sbc-totaldue-box">
          <h2 className="sbc-totaldue-value">
            ...
            <tbody>
              {dueMonths.map((item, index) => (
                <tr key={index}>
                  ...
                  <td>
                    <span className="sbc-status-badge pending">Not Paid</span>
                  </td>
                </tr>
              ))}
            </tbody>
